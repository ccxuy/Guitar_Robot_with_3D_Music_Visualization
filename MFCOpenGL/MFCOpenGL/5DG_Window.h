...
#include "stdafx.h"													// Windows的头文件
#include <gl\gl.h>														// OpenGL32库的头文件
#include <gl\glu.h>														// Glu32库的头文件

#define WM_TOGGLEFULLSCREEN (WM_USER + 1)								// 定义全屏/窗口模式切换消息
#define TITLE		"Music Visulization"							// 定义窗口标题
...
static Application	application;									// 应用程序
static GL_Window	window;											// 窗口
static Keys			keys;											// 键盘按键
static MSG			msg;											// Window消息
static BOOL			isMessagePumpActive;
